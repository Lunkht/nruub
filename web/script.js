document.addEventListener('DOMContentLoaded', () => {
    ...
    function createNewTab() {
        ...
        tab.innerHTML = `
        <span class="tab-title">Nouvell onlet</span>
        ...
        browserView.src = 'new_tab.html';
        contentContainer.appendChild(browserView);

        const newTabInfo = { id: tabId, tabEl: tab, viewEl: browserView, title: 'Nouvell onlet', url: 'new_tab.html', zoom: 1 };
        ...
        browserView.addEventListener('load', () => {
            const newTitle = browserView.contentDocument.title || 'Nouvell onle';
    ...
    ideBtn.addEventListener('click', () => {
        const activeTab = getActiveTab();
        if (activeTab) {
            activeTab.viewEl.src = 'NruubIDE.html';
        }
    });
});